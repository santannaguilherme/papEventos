...
public class InvalidParticipateException extends RuntimeException {


    /**
     *
     */
    private static final long serialVersionUID = -2434552627284509458L;

    public InvalidParticipateException(String message) {
        super(message);
    }
